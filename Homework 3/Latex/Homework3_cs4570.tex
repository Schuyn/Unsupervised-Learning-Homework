...
Additionally, Figure~\ref{fig:sector_correlations} shows the within-sector correlation analysis, where stocks in the same industry (e.g., Tech, Energy) exhibit notably higher correlations than cross-sector pairs.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{Figures/1a_sector_correlations.png}
    \caption{Sector Internal and Cross-Sector Correlation Overview}
    \label{fig:sector_correlations}
\end{figure}
